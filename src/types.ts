...
export type Query={from:string;to:string;category:string;affiliation:string;topic:string;view:'overview'|'countries'|'speakers';profile:Profile|null;page:number;search:string};
